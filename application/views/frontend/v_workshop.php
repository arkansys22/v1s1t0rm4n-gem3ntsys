                  ...
                  <div class="gallery-items big-padding   four-column fl-wrap vis-thumb-info lightgallery">
                      ...
                      <div class="gallery-item nature">
                          <div class="grid-item-holder hov_zoom">
                            <?php if(empty($post->workshop_gambar)) {
                                echo "<img src='".base_url()."bahan/foto_products/noimage.jpg'>";
                              }else {
                                echo " <img src='".base_url('./bahan/foto_workshop/'.$post->workshop_gambar)."'>
                                        <a href='".base_url('./bahan/foto_workshop/'.$post->workshop_gambar)."' class='box-media-zoom   popup-image'><i class='fal fa-search'></i></a>
                                ";}
                             ?>
                              <div class="thumb-info">
                                  <h3><?php echo $post->workshop_judul?></h3>
                                  <p><?php echo $post->workshop_desk?></p>
                              </div>
                          </div>
                      </div>
                    <?php } ?>
