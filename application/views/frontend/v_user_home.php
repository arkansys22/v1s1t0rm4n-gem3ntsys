                      ...
                      <div class="col-sm-12 col-md-3 col-lg-3">
                          ...
                          <div class="dashboard_tab_button">
                              <ul role="tablist" class="nav flex-column dashboard-list">
                                  <li> <a href="#orders" data-toggle="tab" class="nav-link active">Pesanan Saya</a></li>
                                  <li><a href="#address" data-toggle="tab" class="nav-link">Alamat</a></li>
                                  <li><a href="#account-details" data-toggle="tab" class="nav-link">Akun Saya</a></li>
                                  <li><a href="<?php echo base_url()?>paneladmin/logout" class="nav-link">Logout</a></li>
                              </ul>
                          </div>
                      </div>
