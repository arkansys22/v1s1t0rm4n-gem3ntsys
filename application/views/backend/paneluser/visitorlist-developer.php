...
<li class="nav-item">
<a href="#tab-4" data-bs-toggle="tab" class="nav-link active">Waiting (272)</a>
</li>
<li class="nav-item">
<a href="#tab-5" data-bs-toggle="tab" class="nav-link">Approve (218)</a>
</li>
<li class="nav-item">
<a href="#tab-7" data-bs-toggle="tab" class="nav-link">Disapprove (02)</a>
</li>
</ul>
</div>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-01.jpg" alt="User Image">
George Wells
</a>
</h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-15.jpg" alt="User Image">
Timothy Smith
</a>
 </h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-16.jpg" alt="User Image">
Lois Alexander
</a>
</h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-03.jpg" alt="User Image">
Sara Grayson
</a>
</h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-04.jpg" alt="User Image">
Deboarah
</a>
</h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-11.jpg" alt="User Image">
Sofia Briant
</a>
</h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-02.jpg" alt="User Image">
Bess Twishes
</a>
</h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-05.jpg" alt="User Image">
Rayan Lester
</a>
</h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-06.jpg" alt="User Image">
Sarah Alexander
</a>
</h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-14.jpg" alt="User Image">
Janet Paden
</a>
</h2>
</td>
...
<td>
<h2 class="table-avatar">
<a href="profile.html"><img class="avatar-img rounded-circle me-2" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-10.jpg" alt="User Image">
Gary Green
</a>
</h2>
</td>
