              ...
              <div class="row">
                <div class="col-md-4 d-flex">
                  <div class="card wizard-card flex-fill">
                    <div class="card-body">
                    <?php $appointment = $this->Panel_m->view_where_this_join_today('user','user_detail','id_session',array('user_status'=>'2','level' => '4','user_tenant_id_session' => $users_detail['user_tenant_id_session']))->num_rows(); ?>
                ...
                <div class="col-md-4 d-flex">
                  <div class="card wizard-card flex-fill">
                    <div class="card-body">
                    <?php $lobby = $this->Panel_m->view_where_this_join_today('user','user_detail','id_session',array('user_status'=>'1','level' => '4','user_tenant_id_session' => $users_detail['user_tenant_id_session']))->num_rows(); ?>
                ...
                <div class="col-md-4 d-flex">
                  <div class="card wizard-card flex-fill">
                    <div class="card-body">
                     <?php $checkin = $this->Panel_m->view_where_this_join_today('user','user_detail','id_session',array('user_status'=>'3','level' => '4','user_tenant_id_session' => $users_detail['user_tenant_id_session']))->num_rows(); ?>
