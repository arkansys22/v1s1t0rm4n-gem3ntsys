            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <?php
                    echo"<a class='btn btn-primary btn-sm' href='".base_url()."paneladmin/products_cat_restore/$row[products_cat_id]'>Kembalikan</a>
                    <a class='btn btn-danger btn-sm' href='".base_url()."paneladmin/products_cat_delete/$row[products_cat_id]' onclick=\"return confirm('Yakin menghapus $row[products_cat_judul] secara permanen?')\"><i class='fas fa-trash-alt'></i></a>";
                    ?>
                  </td>
                </tr>
              <?php } ?>
