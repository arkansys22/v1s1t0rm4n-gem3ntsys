  ...
  <div class="main-wrapper">
      ...
      <div class="page-wrapper">
        <div class="content container-fluid">
          ...
          <?php $user_status= $this->Crud_m->view_where('user_status', array('user_status_id'=> $rows['user_status']))->row_array(); ?>
          <div class="row">
              <div class="col-lg-3">
                <div class="card">
              ...
              <div class="col-lg-3 d-flex">
                <div class="card w-100">
                  ...
                  <?php if (empty($rows['gambar'])){ ?>
                    <br>
                      <img style="height:200px; width:100%;" src="<?php echo base_url()?>bahan/backend/foto/user-default.png">
                      <div class="card-header mb-4">
