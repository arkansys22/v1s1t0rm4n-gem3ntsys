              ...
              <div class="card-body">
                <div class="table-responsive">
                  <div class="table-responsive">
                    ...
                    <tbody>
                    <?php $user_detail= $this->Crud_m->view_where('user_detail', array('id_session'=> $this->session->id_session))->row_array(); ?>

                    <?php
                      $no = 1;
                     $record = $this->Crud_m->view_join_where_ordering_user_month('user','user_detail','id_session','id_session',array('level'=>'4','user_tenant_id_session'=>$user_detail['user_tenant_id_session']),'user_detail_vdatefrom','DESC');
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="text-end">
                        <a href="<?php echo base_url()?>paneluser/visitor_preview/<?=$row['id_session']?>" class="btn btn-sm btn-secondary me-2"><i class="fas fa-info-circle"></i></a>
