    ...
    <div class="main-wrapper">
      ...
      <div class="page-wrapper">
        ...
        <div class="subscribe-employe users-list">
          <ul>
            <li ><a href="<?php echo base_url() ?>paneluser/tenantssetting/">Active Tenant </a></li>
            <li class="active"><a href="<?php echo base_url() ?>paneluser/tenantssettinginactive/">Inactive Tenant</a></li>
          </ul>
        </div>
                  ...
                  <div class="table-responsive">
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="text-end">
                        <a href="<?php echo base_url()?>paneluser/tenant_replace_temp/<?=$row['user_tenant_id_session']?>" class="btn btn-sm btn-secondary me-2"><i class="fas fa-undo"></i></a>

                        <?php  
                          echo" <a class='btn btn-sm btn-danger' href='".base_url()."paneluser/tenant_delete_perm/$row[user_tenant_id_session]' onclick=\"return confirm('Are you sure want to delete permanent this $row[user_tenant_nama]?')\"><i class='far fa-trash-alt'></i>
                        </a>";
                        ?>                       
                        </td>
                      </tr>
