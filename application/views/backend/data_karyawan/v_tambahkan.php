      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="card card-primary">
            ...
            echo form_open_multipart('paneladmin/data_karyawan_tambahkan',$attributes); ?>
              <div class="card-body">
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-outline-info" title="batal" href="<?php echo base_url()?>paneladmin/data_karyawan"><i class="fab fa-creative-commons-sa"></i> Batal</a>
