...
<ul class="nav user-menu">
    ...
    <img class="avatar-img rounded-circle" alt="" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-02.jpg">
    </span>
    ...
    <div class="media d-flex">
    <span class="avatar avatar-sm flex-shrink-0">
    <img class="avatar-img rounded-circle" alt="" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-03.jpg">
    </span>
    <div class="media-body flex-grow-1">
    ...
    <div class="media d-flex">
    <span class="avatar avatar-sm flex-shrink-0">
    <img class="avatar-img rounded-circle" alt="" src="<?php echo base_url()?>bahan/backend/template/img/profiles/avatar-04.jpg">
    </span>
    <div class="media-body flex-grow-1">
